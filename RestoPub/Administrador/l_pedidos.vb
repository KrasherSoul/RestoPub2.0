Public Class l_pedidos
    ...
    Private Sub TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox1.KeyDown
        ...
        If e.KeyCode = Keys.KeyCode.Enter Then
            sql = "SELECT trabajador.rut as rut FROM trabajador INNER JOIN usuario ON trabajador.rut = usuario.rut where pass= " & TextBox1.Text
            SQLQuery(sql, True)
            If lector.HasRows Then
                While lector.Read
                    pedidos.Label2.Text = Me.Text
                    pedidos.Label3.Text = lector.Item(0)
